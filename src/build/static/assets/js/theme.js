...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('aos'), require('jquery'), require('jarallax'), require('scrollmonitor'), require('smooth-scroll'), require('@tanem/svg-injector'), require('typed.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'aos', 'jquery', 'jarallax', 'scrollmonitor', 'smooth-scroll', '@tanem/svg-injector', 'typed.js'], factory) :
  (global = global || self, factory(global.theme = {}, global.AOS, global.jQuery, global.jarallax, global.scrollMonitor, global.SmoothScroll, global.SVGInjector, global.Typed));
}(this, (function (exports, AOS, jQuery$1, jarallax$1, scrollMonitor, SmoothScroll, svgInjector, Typed) { 'use strict';
